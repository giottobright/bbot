...
const types = [
  { id: 'ipa', label: 'IPA', description: 'India Pale Ale (IPA) - это сильно охмеленное пиво с выраженной горечью и ароматом хмеля.' },
  { id: 'stout', label: 'Stout', description: 'Stout - это темное пиво, приготовленное с использованием жареного ячменя или солодового ячменя.' },
  { id: 'lager', label: 'Lager', description: 'Lager - это пиво, которое ферментируется и выдерживается при низких температурах.' },
];
